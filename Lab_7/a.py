...
def draw_clock():
    ...
    pygame.draw.line(screen, (0, 0, 0), (center_x, center_y), (hour_x, hour_y), 8)  
    pygame.draw.line(screen, (255, 0, 0), (center_x, center_y), (minute_x, minute_y), 4)  
    pygame.draw.line(screen, (0, 0, 255), (center_x, center_y), (second_x, second_y), 2) 
